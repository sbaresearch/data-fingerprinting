...
if __name__ == '__main__':
    ...
    # Optional parameters
    parser.add_argument("--gamma", type=float, default=5.0, help="Gamma value (optional)")
    parser.add_argument("--fp_len", type=int, default=256, help="Fingerprint length (optional)")
    parser.add_argument("--out", default="NCorrFP/example/fingerprinted_output.csv", help="Output file (optional)")
    parser.add_argument("--config", default="NCorrFP/example/config.json", help="Configuration file (optional)")
    parser.add_argument("--log", default="NCorrFP/example/log.json", help="Log file (optional)")
