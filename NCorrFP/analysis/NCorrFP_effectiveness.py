...
from NCorrFP.ncorr import NCorrFP
...
def effectiveness(dataset='covertype-sample', save_results='effectiveness'):
    ...
    if save_results is not None:
        results_frame.to_csv(os.path.join(os.path.dirname(os.path.abspath(__file__)), 'results', save_results), index=False)
